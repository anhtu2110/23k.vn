...
<body>
    ...
    <div id='message'>
        <h4>Ngày <span class="text-green">12/12/2022</span></h4>
        <p>Họ và tên: <span class="text-blue">Nguyễn Minh Hiếu</span></p>
        <p>Số điện thoại: <span class="text-blue">12345565656</span></p>
        <p>Địa chỉ: <span class="text-blue">Thanh Xuân, Thanh Trì, Hà Nội</span></p>
        <p>Giấy tờ chứng minh: <span class="text-blue">Sổ đỏ</span></p>
        <p>Số tiền cần vay: <span class="text-blue">20 triệu</span></p>
        <p>Giấy tờ để lại <span class="text-blue">CCCD chip, đăng ký xe ô tô</span></p>
    </div>
</body>
